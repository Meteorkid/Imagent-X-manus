...
Imagent X is an intelligent agent platform built with Domain-Driven Design (DDD) architecture, featuring:
...
## Default Credentials
- **Admin**: admin@imagentx.ai / admin123
- **Test User**: test@imagentx.ai / test123
