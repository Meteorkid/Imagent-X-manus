...
export function ApiUsageGuide() {
  ...
  const curlExample = `curl -X POST https://api.imagentx.ai/v1/chat/completions \\
...
response = requests.post(
    "https://api.imagentx.ai/v1/chat/completions",
    headers=headers,
    json=data
)
...
axios.post('https://api.imagentx.ai/v1/chat/completions', data, { headers })
  .then(response => {
